...
class HDF5TestCase(unittest.TestCase):
    ...
    def testWriteDict(self):
        ...
        set2['subset'] = {'w1': 1, 'w2': 2,
                          'w3': 3, 'label': 'again some text'}
        data['set2'] = set2

        hdf5.write_dict(data, 'test.hdf5', update=False,
                        attr_types=[float, int, str, list])
    ...
    def testReadDict(self):
        ...
        self.assertEqual(data['set1']['subset']['w3'],
